  ...
  activitiesList.addEventListener("click", async (event) => {
    ...
    try {
      ...
      try {
        ...
        showMessage("Participant removed, but refreshing activities failed.", "error");
        console.error("Error refreshing activities after removal:", refreshError);
      }
    } catch (error) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        try {
          ...
          showMessage("Signup worked, but refreshing activities failed.", "error");
          console.error("Error refreshing activities after signup:", refreshError);
        }
      } else {
